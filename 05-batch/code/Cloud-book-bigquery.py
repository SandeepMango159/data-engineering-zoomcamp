...
# Set also the temporary bucket of the GCS to store temp results before it writes to BigQuery
# Use the bucket that was created with the creation of the data proc cluster
spark.conf.set('temporaryGcsBucket', "dataproc-temp-europe-north2-563514712672-fdkk94ej")
